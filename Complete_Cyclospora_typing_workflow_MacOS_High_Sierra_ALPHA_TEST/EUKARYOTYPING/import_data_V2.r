...
## first check that no columns are completely empty - if any haplotype columns are empty (are full of NA values)
## delete that column - this can happen if a haplotype sheet was generated manually.. It should not happen if a 
## haplotype sheet was generated by Module 1.
