...
current_distance_matrix <- paste("../ensemble_matrices/",todays_date,"_pairwisedistancematrix_ensemble.csv", sep="") ##modify so it puts in the right place.


write.csv(ensemble_pairwisedistancematrix, current_distance_matrix)
