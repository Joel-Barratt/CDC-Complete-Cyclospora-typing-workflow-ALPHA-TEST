...
illumina_adapaters=$working_directory$HAPLOTYPE_CALLER/CYCLO_REF_SEQS/TRIMMING/Illumina_adapters.fasta                                           
...
complete_reference_database=$working_directory$HAPLOTYPE_CALLER/CYCLO_REF_SEQS/BLASTING/ALL_ORIGINAL_REFS/2019_ORIGINAL_REFERENCES_SHORTENED.fasta
...
echo $LOC/TMP > RUN_DIR
echo $complete_reference_database/TMP > ALL_REF
echo $LOC/TMP > LOC
...
bash $LOC/BBMAP/bbmap/bbmerge-auto.sh in1=$working_directory/$SPECIMEN_NAME.clean1.fq in2=$working_directory/$SPECIMEN_NAME.clean2.fq out=$working_directory/$SPECIMEN_NAME.merged.fq outu=$working_directory/$SPECIMEN_NAME.unmerged.fq rem k=62 extend2=50 ecct
