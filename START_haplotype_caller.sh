...
######                                                                         ######################################################################################
#####################################################################################################################################################################
HAPLOTYPE_CALLER=/CYCLONE/HAPLOTYPE_CALLER_CYCLO_V2  # do not modify this line             ##########################################################################
#####################################################################################################################################################################   
																


                                            ##################################################### THE USER SHOULD MODIFY THESE LINES OF THE SCRIPT ONLY. PROVIDE THE 
                                            ################################################### PIPELINE WITH THE LOCATION OF YOUR RAW READS AND OTHER PARAMETERS
                                            ###
                                            ###
                                            ###
                                         #########
...
## DEFAULT FOR THE ILLUMINA ADAPTERS WOULD BE:
#illumina_adapaters=$working_directory$HAPLOTYPE_CALLER/REF_SEQS/TRIMMING/Illumina_adapters.fasta                                           
...
#### this will ensure that any additional text added to the specimen names by the MiSeq is trimmed off.
#### For example, in 2018 the naming convention was as follows: C_IA001_18 <- this is 10 characters long.
...
######################################################################################################################################################################## DO NOT MODIFY SCRIPT BELOW THIS POINT! DEVEL ONLY!
...
echo $NUMBER_OF_CORES > $LOC/TMP/CORES_TO_USE
...
echo "HAPLOTYPE CALLING COMPLETE!!"
